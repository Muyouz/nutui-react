...
const defaultProps: TaroJdToastProps = {
  theme: 'light',
  visible: false,
...
> = (props) => {
  ...
  const renderTitle = () => {
    ...
    if (typeof title === 'string') {
      ...
      return (
        <Text className={titleClasses} style={titleStyle}>
          {title}
        </Text>
      )
    }
  ...
  const renderContent = () => {
    ...
    if (typeof content === 'string') {
      ...
      return (
        <Text className={contentClasses} style={contentStyle}>
          {content}
        </Text>
      )
    }
...
export interface JdToastOptions
  extends Partial<Omit<TaroJdToastProps, 'visible'>> {}
